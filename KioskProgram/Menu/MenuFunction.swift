...
//    
//    override func addSingleBurger(name:String, price:Int){
//        let macMoring = SingleMenu(name: name, price: price)
//        macmoringArray.append(macMoring)
//    }
//    
//    override func addSingleMcMorning(name:String, price:Int){
//        let macMoring = SingleMenu(name: name, price: price)
//        macmoringArray.append(macMoring)
//    }
//    
//    override func addSetBurger(name:String, price:Int){
//        let macMoring = SingleMenu(name: name, price: price)
//        macmoringArray.append(macMoring)
//    }
//    
//    override func addSetMorning(name:String, price:Int){
//        let macMoring = SingleMenu(name: name, price: price)
//        macmoringArray.append(macMoring)
//    }
